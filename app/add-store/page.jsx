...
const AddStrorePage = () => {
  ...
  const [profilePic, setProfilePic] = useState(
    "https://img.freepik.com/premium-vector/round-gray-circle-with-simple-human-silhouette-light-gray-shadow-around-circle_213497-4963.jpg?w=740"
  );
  ...
  return (
    <div className="h-screen  w-full flex items-center justify-center bg-black">
      <Card className="bg-gray-900 text-white p-10 shadow-xl w-full max-w-4xl">
        ...
        <label className="ml-94 mt-0" htmlFor="imageSelect">
          select image
        </label>
        <input
          multiple={false}
...
export default withDashAuth(AddStrorePage);
